...
<div class="tab">
    <div class="header1">
  <button class="tablinks" onclick="openTab(event, 'Users')"><i class="fas fa-user user-icon"></i>Users</button>
  <button class="tablinks" onclick="openTab(event, 'Photos')"><i class="fas fa-camera photos-icon"></i>Photos</button>
  <button class="tablinks" onclick="openTab(event, 'Albums')"><i class="fas fa-folder album-icon"></i>Albums</button>
  </div>
  <div class="header2">
